            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="companydetails">Company Details Entry</a>
                        <a class="collapse-item" href="entryportoflio">Portoflio Entry</a>
                        <a class="collapse-item" href="customersay">Customer Say Entry</a>
                    </div>
                </div>
            </li>
            <!-- Nav Item - Pages Collapse Menu -->
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Customer Say form</h6>
                            ...
                            <form class="user" action="{{ route('customersay.store') }}" method="post">
                             @csrf
                            ...
                            <div class="form-group">
                               ...
                               name="detials" placeholder="Details..."></textarea>
                            </div>
                                <hr>
                                <div>
                                <input type="submit" class="btn btn-primary btn-user btn-block" value="Save Data">                               
                            </div>
                            <div>
                                <input type="submit" class="btn btn-primary btn-user btn-block" value="Save Data">                               
                            </div>
