...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--  Document Title-->
    <!-- ===============================================-->
    <title>{{ config('APP.NAME', 'SonWare Software Development & Innovation Co') }}</title>
   ...
   <!--    Stylesheets of the company dropdown--> 
   <style>
.dropdown {
  position: relative;
        ...
        <div class="container"><a class="navbar-brand" href="home"><img src="assets/img/icons/logo.png" alt="" width="100" /><span class="text-1000 fs-2 ms-2 fw-bold">Empower<span class="fw-bold">Soft</span></span></a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex py-3 py-lg-0">
              <a href="{{ route('books.create') }}" class="btn btn-info rounded-pill order-0" type="submit">Get Quote</a>
            </form>
          </div>
        </div>
      </nav>
        ...
        <div class="container">
          <div class="row flex-center">
            ...
            <div class="col-md-7 col-lg-6 mt-5 text-center text-md-start">
              <h1 class="fw-medium">A Better Way For Complexity!<br /><span class="fw-bold">SmartCreative</span></h1>
              <p class="mt-3 mb-4"><span class="fw-bolder">Get Customized Software for Your Business </span>
                We are an custom software development company we can help you to manage and surface your organization to world organization. For custom software and your requirement send message to us once.</p>
                <a href="{{ route('books.create') }}" class="btn btn-lg btn-danger hover-top btn-glow" href="#">Get Quote </a>
            </div>
          </div>
        </div>
        <!-- end of .container-->
              ...
              <div class="row">
                <div class="col-4">
                  <div class="border-end d-flex justify-content-md-center">
                    ...
                    <div>
                      ...
                      <p class="mb-0">Year of Exoerience </p>
                    </div>
                  </div>
                </div>
                <div class="col-4">
                  <div class="border-end d-flex justify-content-md-center">
                    ...
                    <div>
                      <p class="fw-bolder text-1000 mb-0">12+ </p>
                ...
                <div class="col-4">
                  <div class="d-flex justify-content-md-center">
                    ...
                    <div>
                      <p class="fw-bolder text-1000 mb-0">5+ </p>
                      <p class="mb-0">Pojects completed</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-md-7 col-lg-5 text-center text-md-start">
              <h2>Software Development <br /> Company Afghanistan</h2>
              <p>
                  Software Development Company Afghanistan
                  Empowersoft is a private organization located in Kabul, Afghanistan. We work towards our client’s goals with quality and satisfaction. We choose technologies/platforms such that it suits our client’s requirements and we can deliver things in timely manner. We provide custom application based on your requirements.</p>
              <div class="d-flex">
                ...
                <p class="ms-2 fw-bold">Custom Software Development</p>
              </div>
              <div class="d-flex">
                <svg class="bi bi-check-circle-fill" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#2FAB73" viewBox="0 0 16 16">
                  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"></path>
                </svg>
                <p class="ms-2 fw-bold">Web Development</p>
              </div>
              <div class="d-flex">
                <svg class="bi bi-check-circle-fill" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#2FAB73" viewBox="0 0 16 16">
                  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"></path>
                </svg>
                <p class="ms-2 fw-bold">Database Solutions</p>
              </div>
              <div class="d-flex">
                <svg class="bi bi-check-circle-fill" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#2FAB73" viewBox="0 0 16 16">
                  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"></path>
                </svg>
                <p class="ms-2 fw-bold">E-Commerce Solutions</p>
              </div>
              <div class="d-flex">
                  <svg class="bi bi-check-circle-fill" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#2FAB73" viewBox="0 0 16 16">
                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"></path>
                  </svg>
                  <p class="ms-2 fw-bold">Hire dedicated specialist developers and trainers</p>
                </div>
                <div class="d-flex">
                    <svg class="bi bi-check-circle-fill" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#2FAB73" viewBox="0 0 16 16">
                      <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"></path>
                    </svg>
                    <p class="ms-2 fw-bold">Full-Stack Developer Training</p>
                  </div>
            </div>
          </div>
        </div>
        ...
        <div class="container-lg">
          <div class="row justify-content-center">
            <div class="col-md-6 col-lg-5 text-center mb-3">
              <h2>Quick Estimation To You</h2>
              <p>Just start your dream in the IT world with us in your budget</p>
              <h5>Including 6<small>th</small> months bug warranty and low price</h5>
            </div>
          </div>
          <div class="row h-100 justify-content-center">
            <div class="col-md-4 pt-4 px-md-2 px-lg-3">
              <div class="card h-60">
                <div class="card-body d-flex flex-column justify-content-around mx-auto">
                  <div class="text-center pt-5"><img class="img-fluid" src="assets/img/icons/webdeveloper.JPEG" alt="" />
                  ...
                  <ul class="list-unstyled">
                    ...
                    <li class="mb-3"><span class="me-2">
                        <svg class="bi bi-check" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#2FAB73" viewBox="0 0 16 16">
                          <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z"></path>
                        </svg></span>Web Applications
                    </li>
                    <li class="mb-3"><span class="me-2">
                        <svg class="bi bi-check" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#2FAB73" viewBox="0 0 16 16">
                          <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z"></path>
                        </svg></span>Modern & Secure
                    </li>
                  </ul>
                  <div class="text-center my-5">
                    <button class="btn btn-outline-info rounded-pill" type="submit">MORE</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-4 pt-4 px-md-2 px-lg-3">
              <div class="card h-60">
                <div class="card-body d-flex flex-column justify-content-around mx-auto">
                  <div class="text-center pt-5"><img class="img-fluid" src="assets/img/icons/programmer.png" alt="" />
                    <h5 class="my-4">Custom Software Development</h5>
                  </div>
                  <ul class="list-unstyled">
                    <li class="mb-3"><span class="me-2">
                        <svg class="bi bi-check" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#2FAB73" viewBox="0 0 16 16">
                          <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z"></path>
                        </svg></span>Applications for your Desktop
                    </li>
                    <li class="mb-3"><span class="me-2">
                        <svg class="bi bi-check" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#2FAB73" viewBox="0 0 16 16">
                          <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z"></path>
                        </svg></span>Competitive and Low Price
                    </li>
                    <li class="mb-3"><span class="me-2">
                        <svg class="bi bi-check" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#2FAB73" viewBox="0 0 16 16">
                          <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z"></path>
                        </svg></span>Capable & Fit to business
                    </li>
                    <li class="mb-3"><span class="me-2">
                        <svg class="bi bi-check" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#2FAB73" viewBox="0 0 16 16">
                          <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z"></path>
                        </svg></span>In Your Budget
                    </li>
                  </ul>
                  <div class="text-center my-5">
                    </h2>
            ...
            <div class="col-md-4 pt-4 px-md-2 px-lg-3">
              <div class="card h-100">
                <div class="card-body d-flex flex-column justify-content-around mx-auto">
                  <div class="text-center pt-5"><img class="img-fluid" src="assets/img/icons/trainer.png" alt="" />
                    <h5 class="my-4"></h5>
                  </div>
                  <ul class="list-unstyled">
                    <li class="mb-3"><span class="me-2">
                        <svg class="bi bi-check" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#2FAB73" viewBox="0 0 16 16">
                          <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z"></path>
                        </svg></span>Hire dedicated specialist developers
                    </li>
                    <li class="mb-3"><span class="me-2">
                        <svg class="bi bi-check" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#2FAB73" viewBox="0 0 16 16">
                          <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z"></path>
                        </svg></span>Hire dedicated specialist trainers
                    </li>
                    <li class="mb-3"><span class="me-2">
                        <svg class="bi bi-check" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#2FAB73" viewBox="0 0 16 16">
                          <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z"></path>
                        </svg></span>Hire Freelancer for Your Projects 
                    </li>
                    <li class="mb-3"><span class="me-2">
                        <svg class="bi bi-check" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#2FAB73" viewBox="0 0 16 16">
                          <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z"></path>
                        </svg></span>Full-stack seveloping advanced training
                    </li>
                  </ul>
                  <div class="text-center my-5">
                    <button class="btn btn-info hover-top btn-glow rounded-pill border-0" type="submit">More</button>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="container">
          <div class="row flex-center">
            <div class="col-lg-12 col-lg-12 text-center">
              <h2>Way EmpowerSoft</h2>
              <h5 class="mb-0 fs--0 text-2000 fw-lg">With Competitive Price, we also offer other attractive benefits like</h5><br >
              <div class="row h-100">
                  ...
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="flex-1 ms-3">
                          <h5 class="mb-0 fs--1 text-1000 fw-medium">Agile Methodology Afghanistan</h5>
                        </div>
                      </div>        
                    </div>
                    <div class="d-flex align-items-center"><img class="img-fluid" src="assets/img/gallery/agile.png" alt="" />
                  </div>
                </div>
              </div>
              <div class="col-sm-3 mb-3 mb-md-0">
                <div class="card h-100">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="flex-1 ms-3">
                          <h5 class="mb-0 fs--1 text-1000 fw-medium">3+ Years of Experience Expertise in different domains</h5>
                        </div>
                      </div>        
                    </div>
                    <div class="d-flex align-items-center"><img class="img-fluid" src="assets/img/gallery/agile.png" alt="" />
              ...
              <div class="col-sm-3 mb-3 mb-md-0">
                <div class="card h-100">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="flex-1 ms-3">
                          <h5 class="mb-0 fs--1 text-1000 fw-medium">6 Month Warranty Free bug solving post project delivery</h5>
                        </div>
                      </div>        
                    </div>
                    <div class="d-flex align-items-center"><img class="img-fluid" src="assets/img/gallery/agile.png" alt="" />
              ...
              <div class="col-sm-3 mb-3 mb-md-0">
                <div class="card h-100">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="flex-1 ms-3">
                          <h5 class="mb-0 fs--1 text-1000 fw-medium">Milestone Wise Payment on Client Satisfaction Only </h5>
                        </div>
                      </div>        
                    </div>
                    <div class="d-flex align-items-center"><img class="img-fluid" src="assets/img/gallery/agile.png" alt="" />
  ...
  <div class="container">
    <div class="row flex-center">
      <div class="col-md-8 col-lg-5 text-center">
        <h2>What Customer Say<br />Happy Customer</h2>
        <p>We always try to get in to our customer’s business and figure out what is the best fit for their, and results are below...</p>
      </div>
    </div>
                ...
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center"><img class="img-fluid" src="assets/img/gallery/user-1.png" alt="" />
                      <div class="flex-1 ms-3">
                        <h6 class="mb-0 fs--1 text-1000 fw-medium">Obaid samim</h6>
              ...
              <div class="row">
                <div class="col-4">
                  <div class="border-end d-flex justify-content-md-center">
                    ...
                    <div>
                      ...
                      <p class="fw-bolder text-1000 mb-0">C# </p>
                      <p class="fw-bolder text-1000 mb-0">Oracle 11g </p>
                      <p class="fw-bolder text-1000 mb-0">SQL Server </p><br /><br />
                      <a href="www.Service.com/php" class="btn btn-outline-info rounded-pill">More...</a>
                ...
                <div class="col-4">
                  <div class="border-end d-flex justify-content-md-center">
                    ...
                    <div>
                      <p class="fw-bolder text-1000 mb-0">JavaScript</p>
                      <p class="fw-bolder text-1000 mb-0">HTML5 </p>
                      <p class="fw-bolder text-1000 mb-0">CSS3 </p><br /><br />
                      <a href="www.Service.com/php" class="btn btn-outline-info rounded-pill">More...</a>
                ...
                <div class="col-4">
                  <div class="d-flex justify-content-md-center">
                    ...
                    <div>
                       <p class="fw-bolder text-1000 mb-0">Java </p>
                       <p class="fw-bolder text-1000 mb-0">Python </p>
                       <p class="fw-bolder text-1000 mb-0">PHP & Open Source </p>
                      <p class="fw-bolder text-1000 mb-0">Microsoft .Net</p><br /><br />
                      <a href="www.Service.com/php" class="btn btn-outline-info rounded-pill">More...</a>
            ...
            <div class="card-body">
              <div class="row flex-center">
                <div class="col-12 col-lg-6 text-lg-start">
                  <h2>Talk to us get a Better Way <br />Get Special Features!</h2>
                  <p class="mb-lg-0">Let's share your requirements to us, now a days Afghanistan same situation in IT world, if you want to save your money talk to us once.</p>
                </div>
                <div class="col-12 col-lg-6 text-lg-end"><a class="btn btn-lg btn-danger hover-top btn-glow text-end" href="#">Submit Your Requirements To Us</a></div>
              </div>
            </div>
          </div>
        </div>
