...
<!-- <section> close ============================-->
      ...
      <section class="py-12 z-index-1" style="margin-bottom: -10rem">
        <div class="container">
            <div class="col-lg-12 col-lg-2 mt-5 text-center text-md-start">
              <p style="text-align: center;" class="breadcrumbs" data-scrollax=" properties: { translateY: '70%', opacity: 1.6}"><span class="mr-2"><a href="home">Home</a>/</span> <span>Portifolio</span></p>
  ...
  <div class="w3-row-padding w3-padding-16 w3-center" id="food">
      <div class="w3-quarter">
        <img src="1.jpeg" alt="Sandwich" style="width:100%">
        <h3>The Perfect Sandwich, A Real NYC Classic</h3>
        <p>Just some random text, lorem ipsum text praesent tincidunt ipsum lipsum.</p>
      </div>
      <div class="w3-quarter">
        <img src="1.jpeg" alt="Steak" style="width:100%">
        <h3>Let Me Tell You About This Steak</h3>
        <p>Once again, some random text to lorem lorem lorem lorem ipsum text praesent tincidunt ipsum lipsum.</p>
      </div>
      <div class="w3-quarter">
        <img src="1.jpeg" alt="Cherries" style="width:100%">
        <h3>Cherries, interrupted</h3>
        <p>Lorem ipsum text praesent tincidunt ipsum lipsum.</p>
        <p>What else?</p>
      </div>
      <div class="w3-quarter">
        <img src="1.jpeg" alt="Pasta and Wine" style="width:100%">
    ...
    <div class="w3-row-padding w3-padding-16 w3-center">
      <div class="w3-quarter">
        <img src="1.jpeg" alt="Popsicle" style="width:100%">
        <h3>All I Need Is a Popsicle</h3>
        <p>Lorem ipsum text praesent tincidunt ipsum lipsum.</p>
      </div>
      <div class="w3-quarter">
        <img src="1.jpeg" alt="Salmon" style="width:100%">
      ...
      <div class="w3-quarter">
        <img src="1.jpeg" alt="Croissant" style="width:100%">
        <h3>Le French</h3>
