...
<html lang="en-US" dir="ltr">
  ...
  <body>
    <!--    Main Content-->
    <main class="main shadow-sm" id="top" style="background-color: rgb(255, 255, 255); height: 350px;">
...
<!-- <section> close ============================-->
      ...
      <section class="py-12 z-index-1" style="margin-bottom: -10rem">
        <div class="container">
            <div class="col-lg-12 col-lg-2 mt-5 text-center text-md-start">
              <p style="text-align: center;" class="breadcrumbs" data-scrollax=" properties: { translateY: '70%', opacity: 1.6}"><span class="mr-2"><a href="home">Home</a>/</span><span>Process</span></p>
      ...
      <div class="card py-0 px-1 border-0 shadow-sm">
        ...
        <!-- About Section -->
  <div class="w3-container w3-padding-32" id="process">
      <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">Custome Software & Web based Application Process</h3>
    </div>
    <div class="container">
      <div class="col-12">
    <div class="w3-row-padding w3-grayscale">
      <div class="w3-col-12 l3 m6 w3-margin-bottom">
        <img src="1.jpeg" alt="Dan" style="width:35px; box-shadow: 3px 3px 3px 3px;"><br /><br />
        <h3>Dan s</h3>  
    ...
    <div class="w3-row-padding w3-grayscale">
      ...
      <!-- <section> close ============================-->
      <!-- <section> begin ============================-->
      <section style="background-color:rgb(39, 250, 250);" class="pt-9 pb-0">
        <div class="container">
          <div class="row">
