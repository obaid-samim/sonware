  ...
  <body>
    ...
    <main class="main shadow-sm" id="top" style="background-color: rgb(0, 210, 255); height: 350px;">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-2" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="#"><img src="assets/img/icons/logo.png" alt="" width="100" /><span class="text-1000 fs-2 ms-2 fw-bold">Empower<span class="fw-bold">Soft</span></span></a>
...
<!-- <section> close ============================-->
      ...
      <section class="py-12 z-index-1" style="margin-bottom: -10rem">
        <div class="container">
            <div class="col-lg-12 col-lg-2 mt-5 text-center text-md-start">
              <p style="text-align: center;" class="breadcrumbs" data-scrollax=" properties: { translateY: '70%', opacity: 1.6}"><span class="mr-2"><a href="home">Home</a>/</span> <span>Services</span></p>
              <h1 class="fw-medium">Providing Better Services!<br />  
              </div>
        </div><br /><br />
      <div class="container">
            ...
            <div class="card-body">
              <div class="container">
                <form class="form-inline">
                  <div class="row">
                  <div class="col-2 col-sm-2 text-sm-center col-3 hover-top" style="border-bottom: solid 2px rgb(59, 232, 245);"><p><a class="text-900 text-decoration-none" href="#">Custom Software Development</a></div>
                  <div class="col-2 col-sm-2 text-sm-center col-3 hover-top" style="border-top: solid 2px rgb(59, 232, 245);"><a class="text-900 text-decoration-none" href="#">Web Development</a></div>
                  <div class="col-2 col-sm-2 text-sm-center col-3 hover-top" style="border-bottom: solid 2px rgb(59, 232, 245);"><a class="text-900 text-decoration-none" href="#">Custom Software Database</a></div>
                  <div class="col-2 col-sm-2 text-sm-center col-3 hover-top" style="border-top: solid 2px rgb(59, 232, 245);"><a class="text-900 text-decoration-none" href="#">Hire Developer & Trainers</a></div>
                  <div class="col-2 col-sm-2 text-sm-center col-3 hover-top" style="border-bottom: solid 2px rgb(59, 232, 245);"><a class="text-900 text-decoration-none" href="#">Full-Stack Developer Training</a></div>
                  <div class="col-2 col-sm-2 text-sm-center col-3 hover-top" style="border-top: solid 2px rgb(59, 232, 245);"><a class="text-900 text-decoration-none" href="#">Technologies</a></div></div>
                </form>
              </div>
            </div>
      </div>
      ...
      <div class="card py-0 px-1 border-0 shadow-sm">
            <div class="container">
            
            <div class="container-fluid">
                <h1>Custom Software Development</h1>
                <hr style="width:100px;border:6px solid red; border-radius: 5px;">
        ...
        <div class="card-body " style="background-color:rgba(255, 255, 255);">
              <div class="container"> 
                  <div class="row">
                      <div class="col-6"><a class="btn btn-md btn-danger rounded-pill hover-top btn-glow text-end" href="#">Request a Qoute</a></div>
                          <div class="col-3"><p style="font-size: 19px;">Call or WhatsApp click it:</p></div>
                    <div class="col-3 hover-top">
                    <p class="lh-lg" style="font-size: 19px;"><a class="text-900 text-decoration-none" href="https://wa.me/+93748310001" target="_blank">+93(0)748310001</a></p></div>
          ...
          <div class="row">
            ...
            <div class="col-6 col-lg-3 col-lg-3 mb-3 ps-xxl-7 ps-xl-5">
              ...
              <ul class="list-unstyled mb-lg-4 mb-lg-0">
                ...
                <li class="lh-lg"><a class="text-900 text-decoration-none" href="https://wa.me/+93748310001" target="_blank">+93(0)748310001</a></li><br /><br />
