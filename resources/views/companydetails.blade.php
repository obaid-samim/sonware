                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="member"
                                            placeholder="Member">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" id="experience"
                                            placeholder="Experience">
                                    </div>
                                </div>
                                <div class="form-group row">
                                <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" id="projectcompeleted"
