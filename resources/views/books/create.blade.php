...
<!-- <section> close ============================-->
      ...
      <section class="py-12 z-index-1" style="margin-bottom: -10rem">
        <div class="container">
            <div class="col-lg-12 col-lg-4 mt-5 text-center text-md-start">
              <h1 class="fw-medium">With your organization satisfied with our capability<br />              
              </div>
        </div><br /><br />
      <div class="container">
        <div class="card py-6 px-6 border-0 shadow-sm">
            <div class="card-body">
              <div class="container-fliud">
                <div class="row">
                <h2>Request a Quote</h2><br />
                  <label for="email2" class="mb-1 mr-sm-2">Please your write your requirement and request for a system simple in a document send us we will 
              response within 2 working days:</label><br />
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="col-3"><p style="font-size: 19px;">Call or WhatsApp click it:</p>
                  </div>
                  <div class="col-3 hover-top">
                         <p class="lh-lg" style="font-size: 19px;"><a class="text-900 text-decoration-none" href="https://wa.me/+93748310001" target="_blank">+93(0)748310001</a></p>
                  </div>
