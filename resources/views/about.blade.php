  ...
  <div class="w3-container w3-padding-32" id="about">
    ...
    <div class="w3-row-padding w3-grayscale">
      <div class="w3-col l3 m6 w3-margin-bottom">
        <img src="1.jpeg" alt="John" style="width:100%; box-shadow: 3px 3px 3px 3px;"><br /><br />
        <h3>John Doe</h3>
      ...
      <div class="w3-col l3 m6 w3-margin-bottom">
        <img src="1.jpeg" alt="Jane" style="width:100%; box-shadow: 3px 3px 3px 3px;"><br /><br />
        <h3>Jane Doe</h3>
      ...
      <div class="w3-col l3 m6 w3-margin-bottom">
        <img src="1.jpeg" alt="Mike" style="width:100%; box-shadow: 3px 3px 3px 3px;"><br /><br />
        <h3>Mike Ross</h3>
        <p class="w3-opacity">Architect</p>
        <p>Phasellus eget enim eu lectus faucibus vestibulum. Suspendisse sodales pellentesque elementum.</p>
        <p><button class="w3-button w3-blue w3-block">Contact</button></p>
      ...
      <div class="w3-col l3 m6 w3-margin-bottom">
        <img src="1.jpeg" alt="Dan" style="width:100%; box-shadow: 3px 3px 3px 3px;"><br /><br />
        <h3>Dan Star</h3>
        <p class="w3-opacity">Architect</p>
        <p>Phasellus eget enim eu lectus faucibus vestibulum. Suspendisse sodales pellentesque elementum.</p>
        <p><button class="w3-button w3-blue w3-block">Contact</button></p>
