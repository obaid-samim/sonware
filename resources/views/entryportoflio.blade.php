            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="companydata">Customer Say form</a>
                        <a class="collapse-item" href="companydata">Company Details</a>
                        <a class="collapse-item" href="companydata">Portoflio</a>
                    </div>
                </div>
            </li>
            <!-- Nav Item - Pages Collapse Menu -->
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Website Parts</h1>
                    </div>                
                    </ul>
                </nav>
                <!-- End of Topbar -->
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Portoflio Entry Form</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input name="fullname" type="text" class="form-control form-control-user" id="fullname"
                            ...
                            <div class="form-group">
                                <textarea type="textarea" class="form-control form-control-user" id="details"
                                placeholder="Details..."></textarea>
                            </div>
                                <hr>
                                <div>
                                <input type="submit" class="btn btn-primary btn-user btn-block" id="Save Data">  
                            </div>
                            </form>
                            <hr>    
